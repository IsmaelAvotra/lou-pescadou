  ...
  return (
    <div className="h-30 z-50 fixed backdrop-blur-3xl top-0 w-full">
      ...
      <div className="relative h-20 z-50 flex text-white justify-evenly bg-[#fff] items-center w-full custom-header">
        <Link
          href="/"
          className="drop-shadow-2xl text-xl font-semibold flex justify-between items-center transition-4 text-[#79c8f5]"
        >
          Accueil
        </Link>
        <Link
          href="/#histoire"
          className="drop-shadow-2xl text-xl font-semibold text-[#79c8f5]"
        >
          Notre histoire
        </Link>
        <a
